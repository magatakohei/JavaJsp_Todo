...
/**
 * Servlet implementation class TaskInCompleteServlet
 */
@WebServlet("/incomplete")
public class TaskIncompleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TaskIncompleteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		targetTask.setIsComplete(false);
